...
import top.weixiaoweb.wxfilemanager.databinding.ActivitySearchBinding
...
class SearchActivity : AppCompatActivity() {
    ...
    private fun handleFileClick(file: FileModel) {
        if (file.isDirectory) {
            val intent = android.content.Intent(this, top.weixiaoweb.wxfilemanager.MainActivity::class.java).apply {
