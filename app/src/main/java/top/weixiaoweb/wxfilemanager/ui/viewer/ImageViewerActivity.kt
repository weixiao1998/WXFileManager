...
import top.weixiaoweb.wxfilemanager.adapter.ImagePagerAdapter
import top.weixiaoweb.wxfilemanager.databinding.ActivityImageViewerBinding
...
class ImageViewerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageList = top.weixiaoweb.wxfilemanager.utils.MediaRepository.getImageList()
    ...
    override fun onDestroy() {
        super.onDestroy()
        top.weixiaoweb.wxfilemanager.utils.MediaRepository.clear()
    }
